...
# property 6
class GEPDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(GEPDataset, self).__init__(root, transform, pre_transform)  # transform
